...
os.chdir("C:/Users/Administrator/Desktop")#存放文件位置,LInux和windows的路径格式不一样，需要区分
...
host = 'https://bj.lianjia.com/ershoufang/haidian/pg'
afx='co21sf1a4a5/'
...
wb.save('Haidian_District.xlsx')#文件名
end = time.time()
